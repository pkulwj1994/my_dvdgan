...
def get_parameters():
    ...
    parser.add_argument('--test_batch_size', type=int, default=2, help='how many batchsize for test and sample')

    # Path
    # parser.add_argument('--image_path', type=str, default='/home/luoxw1994/Workspace/01_PythonCodeBase/DVD-GAN/outputs/data')
    # parser.add_argument('--log_path', type=str, default='/home/luoxw1994/Workspace/01_PythonCodeBase/DVD-GAN/outputs/logs')
    # parser.add_argument('--model_save_path', type=str, default='/home/luoxw1994/Workspace/01_PythonCodeBase/DVD-GAN/outputs/models')
    # parser.add_argument('--sample_path', type=str, default='/home/luoxw1994/Workspace/01_PythonCodeBase/DVD-GAN/outputs/samples')

    parser.add_argument('--image_path', type=str, default='/content/outputs/data')
    parser.add_argument('--log_path', type=str, default='/content/outputs/logs')
    parser.add_argument('--model_save_path', type=str, default='/content/outputs/models')
    parser.add_argument('--sample_path', type=str, default='/content/outputs/samples')
    ...
    # parser.add_argument('--root_path', type=str, default='/home/luoxw1994/Workspace/01_PythonCodeBase/DVD-GAN/UCF101')
    ...
    parser.add_argument('--std_norm', action='store_true', default=False)
    parser.add_argument('--mean_dataset', type=str, default='activitynet')
    parser.add_argument('--root_path', type=str, default='/content/UCF101')
    parser.add_argument('--video_path', type=str, default='videos_jpeg')
    parser.add_argument('--annotation_path', type=str, default='annotations/ucf101_01.json')
    parser.add_argument('--train_crop', type=str, default='corner') #corner | random | center
    parser.add_argument('--sample_size', type=int, default=64)
